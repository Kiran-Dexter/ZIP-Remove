...
$link = "https://github.com/DavidFerreira21/Office-365-Licensing-Tool/archive/refs/heads/"
...
"@
    ...
    $Header = @{"api-token"="12345678901"}
     #Invoke-WebRequest -Uri $fullpath -Headers $Header -Method Get -ContentType "Application/Json" -OutFile $destination_path  -Credential $cred
...
function JAVA_run {
    ...
    $java_portable_path = "$dest" + "$file" +"\"+ "$java_portable_name"
